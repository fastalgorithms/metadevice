...
c
c
        subroutine c29triaadam(ier,vert1,vert2,vert3,fun,nm,
...
c        subroutine c29triaadam (see above), and of the vector f in (1) 
c        above
...
c
        ...
        maxdepth=200
c
c        allocate memory for the subroutine c29trianrem
c
        istack=1
        lstack=1207
c
...
c       . . . integrate
c
        call c29trianrem(ier,w(istack),vert1,vert2,vert3,fun,nm,
...
c
c
        subroutine c29triaadam0(ier,vert1,vert2,vert3,fun,nm,
     1      p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,m,eps,cints,
     $      maxrec,numfunev,w)
        implicit real *8 (a-h,o-z)
        dimension vert1(2),vert2(2),vert3(2)
...
c
c
        subroutine c29trianrem(ier,stack,z1,z2,z3,fun,nm,
...
c
        ...
        nrec=1
c
cccc        call prinf('in c29trianrem, nm=*',nm,1)
c
...
c
 1000   continue
c
        call c29triainm1(m,z1,z2,z3,fun,
     1     p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,
...
c
        call c29triainm1(m,zout(1,1,1),zout(1,2,1),zout(1,3,1),fun,
     1     p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,
     $     value1,w,ww,nm,vals2,numnodes)
        numfunev=numfunev+numnodes
c
        call c29triainm1(m,zout(1,1,2),zout(1,2,2),zout(1,3,2),fun,
     1     p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,
     $     value2,w,ww,nm,vals2,numnodes)
        numfunev=numfunev+numnodes
c
        call c29triainm1(m,zout(1,1,3),zout(1,2,3),zout(1,3,3),fun,
     1     p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,
     $     value3,w,ww,nm,vals2,numnodes)
        numfunev=numfunev+numnodes
c
        call c29triainm1(m,zout(1,1,4),zout(1,2,4),zout(1,3,4),fun,
     1     p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,
...
c
c
        subroutine c29triainm1(n,vert1,vert2,vert3,fun,
     1     p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,
     $     cints,w,work,nm,vals,numnodes)
        implicit real *8 (a-h,o-z)
        dimension vert1(1),vert2(1),vert3(1)
        complex *16 cints(1),vals(*),w(1),work(*)
        data nold/-10/
c
...
c
        call c29triainm0(numnodes,w(irnodes),w(iweights),fun,
...
c
c
        subroutine c29triainm0(numnodes,rnodes,weights,fun,
